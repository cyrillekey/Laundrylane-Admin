...
import { UnfoldMoreIcon, ArrowUp01Icon, ArrowDown01Icon, FilterIcon } from "@hugeicons/core-free-icons";
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                ...
                className={
                  pricingFilter === "per-kg" ? "bg-accent" : undefined
                }
              >
                Per Kg
              </DropdownMenuItem>
      ...
      <AlertDialog open={bulkDeleteOpen} onOpenChange={setBulkDeleteOpen}>
        <AlertDialogContent size="sm">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete {selectedCount} catalog
              item{selectedCount !== 1 ? "s" : ""}? This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
